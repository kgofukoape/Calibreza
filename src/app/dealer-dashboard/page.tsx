      ...
      <aside className="w-[280px] bg-[#13151A] border-r border-white/5 flex flex-col fixed h-full z-50">
        ...
        <nav className="flex-1 p-4 overflow-y-auto">
          <ul className="space-y-1">
            ...
            <li><Link href="/training/dashboard" className="flex items-center gap-3 px-4 py-3 hover:bg-white/5 rounded-sm text-[#8A8E99] hover:text-[#F0EDE8] font-bold text-sm transition-colors"><span>🎯</span><span>Training Days</span></Link></li>
