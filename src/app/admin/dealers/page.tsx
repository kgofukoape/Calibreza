            ...
            <li>
              <Link href="/admin/dealers" className="flex items-center gap-3 px-3 py-2.5 rounded-sm bg-[#E63946]/10 border border-[#E63946]/20 text-[#E63946] font-black text-[11px] uppercase tracking-widest">
                ...
                {statusCounts.pending > 0 && (
                  <span className="ml-auto bg-[#F59E0B] text-black text-[9px] font-black px-1.5 py-0.5 rounded-full">{statusCounts.pending}</span>
                )}
              </Link>
            </li>
            <li>
      ...
      <main className="flex-1 ml-[260px] overflow-y-auto">
        <header className="bg-[#0D1420] border-b border-white/5 px-8 py-5 sticky top-0 z-40">
          ...
          <p className="text-white/40 text-xs mt-0.5 uppercase tracking-widest font-bold">
            {dealers.length} total · {statusCounts.pending} pending · {statusCounts.approved} approved
          </p>
        </header>
              ...
              <div className="p-6 space-y-6">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Link href={`/dealers/${selectedDealer.slug}`} target="_blank" className="text-[10px] font-black uppercase tracking-widest text-[#4CC9F0] border border-[#4CC9F0]/30 px-3 py-2 rounded-sm hover:bg-[#4CC9F0]/10 transition-all">
                      View Storefront
                    </Link>
                    <button
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      <div key={doc.label}>
                        ...
                        {doc.url ? (
                          <a href={doc.url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-[#4CC9F0]/10 border border-[#4CC9F0]/20 px-3 py-2 rounded-sm text-[#4CC9F0] text-[10px] font-black uppercase tracking-widest hover:bg-[#4CC9F0]/20 transition-all">
                            📄 View Document
                          </a>
                        ) : (
