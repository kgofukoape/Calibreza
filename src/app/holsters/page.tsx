...
// Temporary Mock Data for Holsters
const DEMO_LISTINGS = [
  { id:'40', title:'Daniel Holsters IWB Glock 19', make:'Daniel Holsters', price:950, province:'Gauteng', condition:'Brand New', category:'holsters', listingType:'dealer' as const, sellerName:'Tactical HQ', calibre:'IWB (Inside Waistband)', featured:true },
  { id:'41', title:'Safariland 6390RDS Level 3 OWB', make:'Safariland', price:3800, province:'Western Cape', condition:'Like New', category:'holsters', listingType:'private' as const, sellerName:'Cape Town EDC', calibre:'OWB (Outside Waistband)' },
  { id:'42', title:'Reaper Custom Appendix Rig (CZ P10C)', make:'Reaper Custom', price:1200, province:'KZN', condition:'Good', category:'holsters', listingType:'private' as const, sellerName:'DBN Defense', calibre:'Appendix Carry' },
  { id:'43', title:'Haley Strategic D3CRM Chest Rig', make:'Haley Strategic', price:4500, province:'Free State', condition:'Brand New', category:'holsters', listingType:'dealer' as const, sellerName:'Bloem Tactical', calibre:'Chest Rigs' },
];
      ...
      <div className="bg-[#191C23] border-b border-white/5 pt-8 pb-8 px-6 md:px-8">
        <div className="max-w-[1280px] mx-auto">
          ...
          <h1 style={{fontFamily:"'Barlow Condensed', sans-serif"}} className="font-extrabold text-4xl md:text-5xl tracking-wide uppercase text-[#F0EDE8]">
            Browse <span className="text-[#C9922A]">Holsters & Tactical</span>
          </h1>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-[1280px] mx-auto w-full px-6 md:px-8 py-8 flex flex-col lg:flex-row gap-8">
        ...
        <aside className="w-full lg:w-[280px] flex-shrink-0 flex flex-col gap-6">
          ...
          <div className="bg-[#191C23] border border-white/5 rounded-md p-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              <span className="text-[12px] font-bold tracking-widest uppercase text-[#8A8E99]">Carry Style</span>
              <div className="flex flex-col gap-2.5 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                {[
                  'OWB (Outside Waistband)', 'IWB (Inside Waistband)', 'Appendix Carry', 
                  'Shoulder Holsters', 'Ankle Holsters', 'Drop Leg / Tactical', 
                  'Chest Holsters', 'Paddle Holsters', 'Duty Holsters', 
                  'Concealment Holsters', 'Magazine Pouches', 'Gun Belts', 
                  'Chest Rigs & Plate Carriers', 'Other'
                ].map(type => (
            ...
            {/* EXHAUSTIVE HOLSTER BRANDS (SA & International) */}
            <div className="flex flex-col gap-3 border-t border-white/5 pt-5">
              <span className="text-[12px] font-bold tracking-widest uppercase text-[#8A8E99]">Brand</span>
              <div className="flex flex-col gap-2.5 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                {[
                  '5.11 Tactical', 'African Leather Works', 'Alien Gear', 'Blackhawk', 
                  'Blade-Tech', 'Blue Force Gear', 'Bushveld Carry', 'Cape Leather Works', 
                  'Comp-Tac', 'Concealment Express', 'Condor Outdoor', 'CrossBreed', 
                  'Crye Precision', 'Cytac', 'Daniel Holsters', 'Ferro Concepts', 'Fobus', 
                  'G-Code', 'Guncraft SA', 'Haley Strategic', 'High Speed Gear', 
                  'Highveld Holsters', 'LBT', 'Mayflower Research', 'PHLster', 
                  'Platatac', 'Protea Tactical', 'Reaper Custom', 'Safari Carry', 
                  'Safariland', 'Serpa', 'SOE Gear', 'Southwestern Holsters', 
                  'Spiritus Systems', 'Tactical Tailor', 'Tier 1 Concealed', 'Tulster', 
                  'Vedder Holsters', 'Velocity Systems', 'VK Holsters', 
                  'We The People Holsters', 'Other'
                ].map(brand => (
            ...
            {/* Platform Compatibility (Glock, CZ, Sig, etc.) */}
            <div className="flex flex-col gap-3 border-t border-white/5 pt-5">
              <span className="text-[12px] font-bold tracking-widest uppercase text-[#8A8E99]">Gun Fitment</span>
              <div className="flex flex-col gap-2.5 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                {[
                  'Glock 19/23/32', 'Glock 17/22/31', 'Glock 43/43X', 'Glock 48', 
                  'CZ P-10 C', 'CZ P-10 F', 'CZ P-07', 'CZ 75 / SP-01', 'CZ Shadow 2', 
                  'Sig P320', 'Sig P365 / XL', 'Smith & Wesson M&P', 'Smith & Wesson Shield', 
                  'Springfield Hellcat', '1911 Platforms', 'Beretta 92', 'Revolver Frames', 
        ...
        <div className="flex-1 flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#191C23] border border-white/5 rounded-md p-4">
            <span className="text-[13px] text-[#8A8E99]">Showing <strong className="text-[#F0EDE8]">950</strong> results for Holsters</span>
