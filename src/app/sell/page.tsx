        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            >
              ...
              href="/dashboard"
              className="flex-1 bg-transparent border border-white/20 text-[#F0EDE8] font-bold text-[16px] uppercase py-4 rounded-sm text-center hover:bg-white/5 transition-all"
            >
              Cancel
            </a>
          </div>
