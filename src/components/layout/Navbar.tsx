    ...
    <nav className="bg-[#0D0F13] border-b border-white/5 sticky top-0 z-50 w-full">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <Link href="/command-center" className="hidden sm:flex items-center gap-2 text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#C9922A] border border-[#C9922A]/30 px-4 py-2 rounded-sm hover:bg-[#C9922A] hover:text-black transition-all">
            Pro Command Center
          </Link>
          <Link href="/signup" className="bg-[#C9922A] text-black text-[11px] font-bold uppercase tracking-widest px-5 py-2.5 rounded-sm hover:brightness-110 transition-all">
            Sign Up
          </Link>
        </div>
